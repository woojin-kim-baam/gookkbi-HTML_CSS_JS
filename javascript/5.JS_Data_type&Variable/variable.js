...
/*
    변수의 중복 선언 : var키워드를 사용하여 선언한 변수는 중복 선언이 가능
*/
var age = 20;
var age = 10;
...
let address = "부산광역시";
// let address = '울산광역시'; // 컴파일 언어가 아니기에 원래 이렇게 에러가 안뛰우는데 vscode에서 자체적으로 읽고 띄움.
...
/*
    ...
    - 블록 레벨 스코프 : 코드 블럭 내에서 선언된 변수는 해당 코드 블럭 내에서만 사용 가능, 코드 블럭 밖에서는 사용 불가능능
*/
