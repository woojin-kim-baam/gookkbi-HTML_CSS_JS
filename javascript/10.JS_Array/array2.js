...
/*
    ...
    - 원본 배열 변경 X
    - break, continue 등 일반 반목문에서 사용되는 부수작업을 수행할 수 없음
    - for문 보다 성능이 많이 떨어짐, 가독성이 좋고 편리해서 사용
    - async await 작업(동기처리)은 forEach 메서드로 사용 불가능, 동기처리는 for문에서만 가능
*/
